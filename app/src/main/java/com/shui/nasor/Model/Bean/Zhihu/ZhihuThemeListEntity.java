...
public class ZhihuThemeListEntity implements Serializable {

    private static final long serialVersionUID = 1141726321532180938L;
    ...
    public static ZhihuThemeListEntity objectFromData(String str) {

        return new Gson().fromJson(str, ZhihuThemeListEntity.class);
    }
