package com.shui.nasor.Model.Bean.WeChat;
...
public class WeChatEntity implements Serializable {
    private static final long serialVersionUID = 1900888602606141990L;
    ...
    public static WeChatEntity objectFromData(String str) {

        return new Gson().fromJson(str, WeChatEntity.class);
    }
