...
public class ZhihuThemeDetailEntity implements Serializable {
    private static final long serialVersionUID = -1640206017787662840L;
    ...
    public static ZhihuThemeDetailEntity objectFromData(String str) {

        return new Gson().fromJson(str, ZhihuThemeDetailEntity.class);
    }
